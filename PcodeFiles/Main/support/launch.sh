...
SUPPORT_DIR="${0%/*}/support"
if [ -f "${SUPPORT_DIR}/launch.properties" ]; then

	# Production Environment
	INSTALL_DIR="${SUPPORT_DIR}/.."
	CPATH="${INSTALL_DIR}/PcodeFiles/Main/lib/Main.jar:${INSTALL_DIR}/Ghidra/Framework/Utility/lib/Utility.jar:${INSTALL_DIR}/Ghidra/Features/Base/lib/Base.jar:${INSTALL_DIR}/Ghidra/Features/FunctionGraph/lib/FunctionGraph.jar:${INSTALL_DIR}/Ghidra/Features/Python/lib/Python.jar:${INSTALL_DIR}/Ghidra/Features/Python/lib/jython-standalone-2.7.2.jar:${INSTALL_DIR}/Ghidra/Framework/Docking/lib/Docking.jar:${INSTALL_DIR}/Ghidra/Framework/Project/lib/Project.jar:${INSTALL_DIR}/Ghidra/Framework/Project/lib/commons-compress-1.19.jar:${INSTALL_DIR}/Ghidra/Framework/Utility/lib/Utility.jar:${INSTALL_DIR}/Ghidra/Framework/Base/lib/Base.jar:${INSTALL_DIR}/Ghidra/Features/FunctionGraph/lib/FunctionGraph.jar:${INSTALL_DIR}/Ghidra/Features/Python/lib/Python.jar:${INSTALL_DIR}/Ghidra/Features/Python/lib/jython-standalone-2.7.2.jar:${INSTALL_DIR}/Ghidra/Framework/Docking/lib/Docking.jar:${INSTALL_DIR}/Ghidra/Framework/Generic/lib/Generic.jar:${INSTALL_DIR}/Ghidra/Framework/FileSystem/lib/FileSystem.jar"
...
if [ "${BACKGROUND}" = true ]; then
	eval "\"${JAVA_CMD}\" ${VMARG_LIST} -showversion -cp \"${CPATH}\" pcodefiles.PcodeFilesLauncher ${CLASSNAME} ${ARGS[@]}" &>/dev/null &

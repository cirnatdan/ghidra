 ...
 */
public class PcodeFilesLauncher {
	...
	public static void main(String[] args) throws Exception {
		...
		if (!(ClassLoader.getSystemClassLoader() instanceof ghidra.GhidraClassLoader)) {
		...
		PcodeFilesApplicationLayout layout = new PcodeFilesApplicationLayout();
